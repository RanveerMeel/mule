...
// TODO(fernandezlautaro): MULE-10866 despite this suite of tests are contained in the ./tests/integration/src/test/java/org/mule/test/operation/ is should be optimal if every test is splitted into several and smaller ones, more descriptive and easy to debug if needed
public class XmlBasedDescriberTestCase extends AbstractMuleTestCase {
  ...
  public void testModuleGlobalElement() {
    // TODO(fernandezlautaro): MULE-10866 this test takes 2-3 seconds, and it seems to be because it's looking for the XSD for the HTTP connector. Either provide the xsd for it, or replace for other global element self contained in the mule-core XSD
